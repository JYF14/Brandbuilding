...
const defs: Def[] = [
  ...
  },
  {
    ...
    name: "The Gstaad Cashmere Crewneck",
    gender: "men",
    category: "Cashmere",
    collections: ["cashmere"],
    silhouette: "knit",
    ...
    rating: 4.7,
    reviewCount: 29,
    colors: [IVORY, OATMEAL, STONE, ESPRESSO],
    sizes: CLOTHING_SIZES_M,
    materials: ["100% cashmere"],
    description:
      "A crew-neck cashmere knit with a clean, regular fit — a foundation piece for layering beneath a coat or worn alone.",
    details: [
      "100% pure cashmere",
      "Made in Italy",
      "Regular fit",
    ...
    scene: "seated at a mountain restaurant terrace table with a glass of wine",
  },
  {
